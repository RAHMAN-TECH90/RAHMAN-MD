...
module.exports = {
    ...
    OWNER_REACT: process.env.OWNER_REACT || "false",            // Auto-react to owner messages?
    ...
    MENU_IMAGE_URL: getConfig("MENU_IMAGE_URL") || "https://files.catbox.moe/kgh8i3.jpg",  // Bot's "alive" menu image

    // ===== SECURITY & ANTI-FEATURES =====
    ANTI_DELETE: process.env.ANTI_DELETE || "true",             // Recover deleted messages 
    ANTI_CALL: process.env.ANTI_CALL || "false",                // Reject calls automatically 
    ...
    AUTO_STATUS_SEEN: process.env.AUTO_STATUS_SEEN || "true",   // View status updates?
    AUTO_BIO: process.env.AUTO_BIO || "false",                  // Enable auto bio?
    WELCOME: process.env.WELCOME || "false",                    // Welcome message in groups?
    GOODBYE: process.env.GOODBYE || "false",                    // Goodbye message in groups?
    ADMIN_ACTION: process.env.ADMIN_ACTION || "false",          // Show admin activity?
};
