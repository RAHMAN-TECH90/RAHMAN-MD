...
async (conn, mek, m, { from, prefix, quoted, q, reply }) => {
    try {
        ...
        // Validate input
        if (!q) {
            return await reply("*Example : .Pair 923015954782*");
        }

        // Fetch pairing code
        //const fetch = require("node-fetch");
        const response = await fetch(`https://ali-pair-xode.onrender.com/code?number=${q}`);
        ...
        const doneMessage = "> *RAHMAN-MD PAIR COMPLETED*";
